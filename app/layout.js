...
export const metadata = {
  ...
  description:
    'VDS General Trading LLC is a Dubai-based UAE-registered company specializing in wholesale agro commodity trading (onion, potato, garlic), MOHAP-compliant medical equipment supply, and AI voice & email automation agents. Serving UAE, GCC, Europe and United States markets.',
  keywords: [
    'VDS General Trading',
...
const organizationJsonLd = {
  ...
  '@graph': [
    ...
    },
    {
      ...
      areaServed: ['United Arab Emirates', 'GCC', 'Europe', 'United States'],
    },
  ],
};
